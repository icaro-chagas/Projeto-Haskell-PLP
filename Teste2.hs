...
jogaJogador1 mesaInit jogador1 jogador2 shuffledDeck = do
    ...
    if (tipo mesa2 == "Pular")
        then do jogaJogador1 mesa2 jogador1 jogador2 shuffledDeck
    
    else if (lenJ11 == lenJ12)
...
incementaMaoJogador1 mesaInit jogador1 jogador2 shuffledDeck = do
    ...
    if ((mesaInit /= mesa2) && (tipo mesa2 == "Pular"))
        then do jogaJogador1 mesa2 jogador1 jogador2 shuffledDeck
...
jogaJogador2 mesaInit jogador1 jogador2 shuffledDeck = do
    ...
    if ((mesaInit /= mesa2) && (tipo mesa2 == "Pular"))
        then do jogaJogador2 mesa2 jogador1 jogador2 shuffledDeck
    
    else if (lenJ21 == lenJ22)
...
jogador1 :: [Carta]
jogador1 = [Carta "Um" "Amarela",Carta "Tres" "Amarela", Carta "Dois" "Vermelha", Carta "Dois" "Verde"]

jogador2 :: [Carta]
jogador2 = [Carta "Pular" "Vermelha", Carta "Tres" "Verde", Carta "Pular" "Verde", Carta "Dois" "Verde"]
